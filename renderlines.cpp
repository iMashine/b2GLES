...
RenderLines::RenderLines(Camera *camera)
{
    g_camera = camera;
}

void RenderLines::Create(QOpenGLFunctions *functions)
{
    const char *vs = \
...
void RenderLines::Destroy()
{

}

void RenderLines::Vertex(const b2Vec2 &v, const b2Color &c)
{
...
void RenderLines::Flush()
{
    ...
    m_functions.glDrawArrays(GL_LINES, 0, m_count);
