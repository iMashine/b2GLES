...
public:
    ...
    void Step(Settings *settings)
    {
        ...
        g_debugDraw.DrawString(m_painter, 5, m_textLine, "Press g to generate a new random convex hull");
        ...
        for (int32 i = 0; i < m_count; ++i) {
            ...
            char buffer[1024];
            sprintf(buffer, "%d", i);
            g_debugDraw.DrawString(m_painter, m_points[i] + b2Vec2(0.05f, 0.05f), buffer);
        }
