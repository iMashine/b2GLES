...
public:
    ...
    void Step(Settings *settings)
    {
        ...
        g_debugDraw.DrawString(m_painter, 5, m_textLine, "Press 1-5 to drop stuff");
        m_textLine += DRAW_STRING_NEW_LINE;
        g_debugDraw.DrawString(m_painter, 5, m_textLine, "Press 'a' to (de)activate some bodies");
        m_textLine += DRAW_STRING_NEW_LINE;
        g_debugDraw.DrawString(m_painter, 5, m_textLine, "Press 'd' to destroy a body");
        m_textLine += DRAW_STRING_NEW_LINE;
    }
